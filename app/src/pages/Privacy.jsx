        ...
        <div className="bg-white dark:bg-gray-800 bg-opacity-90 border border-gray-200 dark:border-gray-700 shadow-md rounded-lg p-6 backdrop-blur">
          ...
          <div className="space-y-6 prose dark:prose-invert max-w-none">
            ...
            <p>
              ...
              information when you use our platform, including any websites,
              mobile applications, and services (collectively, the "Service")
              operated by GamifyEd-AI, Inc. ("we," "us," or "our").
            </p>
            <p>
            ...
            <p>
              ...
              or navigate the Service. This information may include:
            </p>
            <ul>
              <li>
              ...
              <li>
                Learning activities (such as quizzes taken, podcasts listened
                to)
              </li>
              <li>
                Performance metrics (such as quiz scores, completion rates)
              </li>
              <li>
                Gamification data (such as points earned, achievements unlocked,
                levels reached)
              </li>
            </ul>
            ...
            <p>
              ...
              social media platforms, if you choose to link your account with
              those services.
            </p>
            ...
            <p>
              If you are a student, we may share your information with your
              teachers, school administrators, or parents/guardians as necessary
            ...
            <p>
              ...
              potential threats to the safety of any person, or as evidence in
              litigation.
            </p>
            ...
            <p>
              For users between the ages of 13 and 18, we collect and process
              information with the consent of a parent or guardian, in
            ...
            <ul>
              ...
              <li>
                The right to request that we correct or update any personal
            ...
            <p>
              ...
              the content of these third-party sites. We encourage you to read
            ...
            <p>
              ...
              activities on our Service. You can instruct your browser to refuse
              all cookies or to indicate when a cookie is being sent.
            </p>
            <p>
              We use analytics services such as Google Analytics to help us
              understand how users engage with the Service. These services may
              use cookies and similar technologies to collect information about
            ...
            <p>
              ...
              experiences. These technologies may process your information,
              including your learning activities and performance, to generate
              content and recommendations tailored to your needs.
            </p>
            <p>
              We take measures to ensure that our AI systems process your
