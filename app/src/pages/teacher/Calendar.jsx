        ...
        <main className="flex flex-col gap-6 py-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Schedule and manage your classes and events</p>
            </div>
            <Dialog>
                ...
                <div className="grid gap-4 py-4 relative">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="grid gap-2">
                      ...
                      <Input id="eventDate" type="date" className="border-primary/20 focus-visible:ring-primary/30" />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="eventTime">Time</Label>
                      <Input id="eventTime" type="time" className="border-primary/20 focus-visible:ring-primary/30" />
                    </div>
                  </div>
                  <div className="grid gap-2">
              ...
              <CardContent className="relative">
                <div className="grid grid-cols-7 gap-1 text-center mb-2">
                  {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day, i) => (
                    <div key={i} className="text-sm font-medium text-muted-foreground py-1">
                      {day}
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-6">
              <Card className="backdrop-blur bg-background/80 border-primary/20 overflow-hidden">
                ...
                <CardHeader className="relative">
                  <CardTitle className="text-lg">{selectedDate ? formatDate(selectedDate) : "Select a date"}</CardTitle>
                  {selectedDate && (
                    <CardDescription>
