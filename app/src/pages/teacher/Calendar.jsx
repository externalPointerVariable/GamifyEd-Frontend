...
export default function TeacherCalendar() {
  ...
  const events = [
    ...
    },
    {
      ...
      time: "2:00 PM",
      type: "podcast",
      description: "Listen to podcast about World War II",
    },
    {
      id: 3,
      title: "Science Quiz",
    ...
    },
    {
      ...
      time: "4:00 PM",
      type: "other",
      description: "Virtual study group for upcoming exams",
    },
  ];
              ...
              {selectedDateEvents.map((event) => (
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-xs px-2 py-0.5 bg-zinc-300 dark:bg-zinc-700 rounded">
                      {event.time}
                    </span>
                  </div>
