...
export default function Achievements() {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "Listen to 10 AI podcasts",
    ...
    },
    {
      ...
      description: "Complete all quizzes in a subject area",
    ...
    },
    {
      ...
      description: "Listen to podcasts for a total of 2 hours",
      icon: <MessageSquare className="h-5 w-5" />,
      progress: 45,
      completed: false,
      category: "podcasts",
    ...
    },
    {
      id: 8,
      title: "Early Bird",
      description: "Complete a learning activity before 8 AM",
      icon: <Star className="h-5 w-5" />,
      progress: 100,
      completed: true,
      category: "engagement",
    ...
    },
    {
      id: 9,
      title: "Night Owl",
      description: "Complete a learning activity after 10 PM",
      icon: <Star className="h-5 w-5" />,
      progress: 100,
      completed: true,
      category: "engagement",
  ...
  return (
    <div className="flex min-h-screen flex-col relative dark:bg-gray-950 dark:text-white ">
      ...
      <div className="relative z-10 container grid flex-1 gap-6 md:grid-cols-[200px_1fr] lg:grid-cols-[250px_1fr] py-6">
        <StudentSidebar />
        <main className="flex flex-col gap-6">
          ...
          <Card className="backdrop-blur bg-background/80 border-primary/20">
            <CardHeader>
              ...
              <CardDescription>
                Your achievement progress at a glance
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {filteredAchievements.map((achievement) => (
                <Card
                  key={achievement.id}
                  className="backdrop-blur bg-background/80 border-primary/20"
                >
