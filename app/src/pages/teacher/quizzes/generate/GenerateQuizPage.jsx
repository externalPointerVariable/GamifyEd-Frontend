                ...
                {!generatedQuiz ? (
                  <Card className="backdrop-blur bg-background/80 border-primary/20 overflow-hidden">
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription>
                        Our AI will create a quiz based on your specifications
                      </CardDescription>
                    </CardHeader>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-4">
                          <Button
                            type="button"
                            variant={
                              difficulty === "easy" ? "default" : "outline"
                            }
                          ...
                          <Button
                            type="button"
                            variant={
                              difficulty === "medium" ? "default" : "outline"
                            }
                          ...
                          <Button
                            type="button"
                            variant={
                              difficulty === "hard" ? "default" : "outline"
                            }
                  ...
                  <Card className="backdrop-blur bg-background/80 border-primary/20 overflow-hidden">
                    ...
                    <CardHeader className="relative">
                      ...
                      <CardDescription>
                        Review and edit the AI-generated quiz before saving
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6 relative">
                      {generatedQuiz.questions.map((question, qIndex) => (
                        <div
                          key={qIndex}
                          className="space-y-3 p-4 rounded-md border border-primary/20"
                        >
                          <div className="flex items-center justify-between">
              ...
              <TabsContent value="improve" className="space-y-4 pt-4">
                <Card className="backdrop-blur bg-background/80 border-primary/20 overflow-hidden">
                  ...
                  <CardHeader className="relative">
                    ...
                    <CardDescription>
                      Paste your existing questions and our AI will enhance them
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 relative">
                    <div className="space-y-2">
                      <Label htmlFor="existingQuestions">
                        Existing Questions
                      </Label>
                      <Textarea
